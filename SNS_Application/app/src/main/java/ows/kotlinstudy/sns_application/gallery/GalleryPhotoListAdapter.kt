...
import ows.kotlinstudy.sns_application.databinding.ViewholderGalleryPhotoItemBinding
...
class GalleryPhotoListAdapter(
    ...
    override fun onBindViewHolder(holder: PhotoItemViewHolder, position: Int) {
        holder.bindData(galleryPhotoList.get(position))
        holder.bindViews(galleryPhotoList.get(position))
    }
