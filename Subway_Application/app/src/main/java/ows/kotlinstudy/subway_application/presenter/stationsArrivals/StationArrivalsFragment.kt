...
import ows.kotlinstudy.subway_application.databinding.FragmentStationArrivalsBinding
...
class StationArrivalsFragment: ScopeFragment(), StationArrivalsContract.View {
    ...
    override fun showStationArrivals(arrivalInformation: List<ArrivalInformation>) {
        ...
        (binding?.recyclerView?.adapter as? StationArrivalsAdpater)?.run{
    ...
    private fun initViews(){
        binding?.recyclerView?.apply {
            ...
            adapter = StationArrivalsAdpater()
